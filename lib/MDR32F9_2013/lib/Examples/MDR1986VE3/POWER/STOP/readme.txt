  /**
  @page STOP_3T STOP for MDR1986VE3 Complexity Evaluation Board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2013 Milandr ***********************************
  * @file    Examples/MDR1986VE3_EVAL/POWER/STOP/readme.txt
...
@par Directory "Examples/MDR1986VE3_EVAL" contains:
  ...
  - POWER/STOP/MDR1986VE3_IT.c              Main Interrupt Service Routines
  - POWER/STOP/MDR1986VE3_IT.h              Functions prototypes for the interrupt

@par Hardware and Software environment:

  - This example is intended to run on MDR1986VE3 eval board with MDR1986VE3 microcontroller.
  - V57 (LED1) is connected to PB.0 pin.
