/**
 ******************************************************************************
 * @file    Examples/MDR1986VE3/EEPROM/MassErase/main.c
...
#define LED_MASK                    (PORT_Pin_0 | PORT_Pin_1 | PORT_Pin_2 | PORT_Pin_3)
...
void main ( void )
{
	...
	/* Configure PORTB pins 0...3 for output to switch LEDs on/off */
