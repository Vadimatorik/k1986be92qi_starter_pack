...
#if defined (USE_MDR1986VE3_Rev0) || defined (USE_MDR1986VE3_Rev1) ||\
...
#if (((!defined(USE_MDR1986VE3)) || (!defined(USE_MDR1986VE3))) && (defined(USE_MDR1986VE9x)))
/* #define USE_JTAG_A */
 #define USE_JTAG_B 
#endif
...
#if defined ( USE_MDR1986VE3 ) || defined ( USE_MDR1986VE3 )
	#define MIL_STD_1553_TERMINAL_ADDRESS	0x01
#endif /* #if defined ( USE_MDR1986VE3 ) || defined ( USE_MDR1986VE3 ) */
