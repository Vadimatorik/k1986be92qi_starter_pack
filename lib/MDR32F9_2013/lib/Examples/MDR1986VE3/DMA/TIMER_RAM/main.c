/**
  ******************************************************************************
  * @file    Examples/MDR1986VE3/DMA/TIMER_RAM/main.c
...
/** @addtogroup DMA_TIMER_RAM_3T DMA_TIMER_RAM
  * @{
  */
...
void main(void)
{
	...
	while (1) {
		dma_status =
				(DMA_ControlTable[DMA_Channel_REQ_TIM1 ].DMA_Control & 0x07);
		if (dma_status == 0)
			break;
	}
