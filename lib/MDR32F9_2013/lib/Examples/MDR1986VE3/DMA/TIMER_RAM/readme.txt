  /**
  @page TIMER_RAM_3T TIMER_RAM for MDR1986VE3 Complexity Evaluation Board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2013 Milandr ***********************************
  * @file    Examples/MDR1986VE3/DMA/TIMER_RAM/readme.txt
  * @author  Milandr Application Team
  * @version V1.0.0
  * @date    14/06/2013
  * @brief   Description of the DMA TIMER Example.
  ******************************************************************************
...
@par Directory "Examples/MDR1986VE3" contains:
  ...
  - DMA/TIMER_RAM/main.c          Main program

@par Hardware and Software environment:

  - This example is intended to run on MDR1986VE3 eval board with MDR1986VE3 microcontroller.
  - Connect TIMER1 CH1 (PE3) pin (XP27.22) to TIMER1 CH2 (PE4) pin (X27.23).
