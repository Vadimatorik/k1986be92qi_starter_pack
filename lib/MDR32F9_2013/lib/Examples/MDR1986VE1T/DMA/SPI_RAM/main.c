/**
  ******************************************************************************
  * @file    Examples/MDR1986VE1T/DMA/SPI_RAM/main.c
...
/** @addtogroup DMA_SPI_RAM_1T DMA_SPI_RAM
  * @{
  */
...
uint16_t SrcBuf1[BufferSize] IAR_SECTION ("EXECUTABLE_MEMORY_SECTION");
uint16_t SrcBuf2[BufferSize] IAR_SECTION ("EXECUTABLE_MEMORY_SECTION");
uint16_t DstBuf1[BufferSize] IAR_SECTION ("EXECUTABLE_MEMORY_SECTION");
uint16_t DstBuf2[BufferSize] IAR_SECTION ("EXECUTABLE_MEMORY_SECTION");
...
void main(void)
{
  ...
  /* Configure PORTF pins 12, 13, 14, 15 */
  ...
  /* Init DMA channel */
  DMA_Init(DMA_Channel_REQ_SSP1_RX, &DMA_InitStr);
  ...
  /* Init DMA channel */
  DMA_Init(DMA_Channel_REQ_SSP1_TX, &DMA_InitStr);
