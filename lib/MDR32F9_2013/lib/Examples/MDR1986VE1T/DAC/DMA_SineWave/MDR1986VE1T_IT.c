...
void DMA_IRQHandler ( void )
{
  ...
  if((MDR_DMA->CHNL_PRI_ALT_SET & (1<<DMA_Channel_REQ_TIM1)) == (0<<DMA_Channel_REQ_TIM1))
  {
    DMA_AltCtrlStr.DMA_CycleSize = 32;
    DMA_Init(DMA_Channel_REQ_TIM1, &DMA_InitStr);
  }
  else if((MDR_DMA->CHNL_PRI_ALT_SET & (1<<DMA_Channel_REQ_TIM1)) == (1<<DMA_Channel_REQ_TIM1))
  {
