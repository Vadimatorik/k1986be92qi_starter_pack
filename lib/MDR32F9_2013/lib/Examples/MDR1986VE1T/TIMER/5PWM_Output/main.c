/**
  ******************************************************************************
  * @file    Examples/MDR1986VE1T_EVAL/TIMER/5PWM_Output/main.c
...
void main(void)
{
  ...
  PORT_InitStructure.PORT_Pin   = (PORT_Pin_6 | PORT_Pin_7 | PORT_Pin_8 | PORT_Pin_9 | PORT_Pin_10);
...
/** @} */ /* End of group TIMER_5PWM_Output_1T */
