/**
 ******************************************************************************
 * @file    Examples/MDR1986VE1T/PORT/Joystick_LEDs/main.c
...
/** @addtogroup PORT_Joystick_LEDs_1T PORT_Joystick_LEDs
 * @{
 */
...
void main ( void )
{
	...
	/* In this infinite loop, joystick are iteratively scanned and
	 ...
	 Note: in this example, the following fact about MDR1986VE1T eval board is used: the
...
/** @} *//* End of group PORT_Joystick_LEDs_1T */
