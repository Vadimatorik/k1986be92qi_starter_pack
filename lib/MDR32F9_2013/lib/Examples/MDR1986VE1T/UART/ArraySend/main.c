/**
 ******************************************************************************
 * @file    Examples/MDR1986VE1T_EVAL/UART/ArraySend/main.c
...
/** @addtogroup UART_ArraySend_1T UART_ArraySend
 * @{
 */
...
int main ( void )
{
	...
	UART_DMAConfig(MDR_UART1, UART_IT_FIFO_LVL_12words,
			UART_IT_FIFO_LVL_12words );
	UART_DMACmd(MDR_UART1, UART_DMA_TXE | UART_DMA_RXE | UART_DMA_ONERR,
			ENABLE);
...
/** @} *//* End of group UART_ArraySend_1T */
