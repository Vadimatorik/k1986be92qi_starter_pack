/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q3_EVAL/CAN/LoopBack_Interrupt/main.c
...
/** @addtogroup CAN_LoopBack_Interrupt_93 CAN_LoopBack_Interrupt
  * @{
  */
...
uint32_t main(void)
{
  ...
  /* Configure PORTF pins 0,1 for output to switch LED on/off */
...
/** @} */ /* End of group CAN_LoopBack_Interrupt_93 */
