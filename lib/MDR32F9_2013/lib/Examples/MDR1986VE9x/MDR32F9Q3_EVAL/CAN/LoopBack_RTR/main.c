/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q3_EVAL/CAN/LoopBack_RTR/main.c
...
/** @addtogroup CAN_LoopBack_RTR_93 CAN_LoopBack_RTR
  * @{
  */
...
uint32_t main(void)
{
  ...
  /* Configure PORTF pin 0,1 for output to switch LED on/off */
