/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q3_EVAL/EEPROM/Code_in_RAM/main.c
...
/** @addtogroup EEPROM_Code_in_RAM_93 EEPROM_Code_in_RAM
  * @{
  */
...
uint8_t WriteErrIM=0;
  ...
  /* Configure PORTF pin 0,1 for output to switch LEDs on/off */
...
/** @} */ /* End of group EEPROM_Code_in_RAM_93 */
