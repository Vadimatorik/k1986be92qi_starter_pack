/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q3_EVAL/POWER/STOP/main.c
...
/** @addtogroup POWER_STANDBY_93 POWER_STANDBY
  * @{
  */
...
void main(void)
{
 ...
 /* Configure PORTC pins 13 for input EXT_INT4 */
  ...
  /* STOP mode */
  POWER_EnterSTOPMode(DISABLE,POWER_STOPentry_WFI);
