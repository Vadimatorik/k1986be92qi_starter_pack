  /**
  @page SPI_RAM_91 SPI_RAM for MDR32F9Q1 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2011 Milandr ***********************************
  * @file    Examples/MDR32F9Q1_EVAL/DMA/SPI_RAM/readme.txt
...
@par Hardware and Software environment:
  ...
  - Connect SSP1 RXD pin (X32.1.30) to SSP2 RXD pin (X33.2.13).
  - Connect SSP1 TXD pin (X32.1.31) to SSP2 TXD pin (X32.1.20).
