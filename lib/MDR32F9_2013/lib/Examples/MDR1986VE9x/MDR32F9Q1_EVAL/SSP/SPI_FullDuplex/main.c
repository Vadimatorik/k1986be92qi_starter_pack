/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q1_EVAL/SSP/SPI_FullDuplex/main.c
...
/** @addtogroup SPI_FullDuplex_91 SPI_FullDuplex
  * @{
  */
...
void main(void)
{
  ...
  RST_CLK_PCLKcmd((RST_CLK_PCLK_PORTF | RST_CLK_PCLK_PORTD | RST_CLK_PCLK_PORTE), ENABLE);
...
/** @} */ /* End of group SPI_FullDuplex_91 */
