/**
  ******************************************************************************
  * @file    Examples/MDR32F9Q1_EVAL/COMP/Internal_Scale/main.c
...
/** @addtogroup COMP_Internal_Scale_91 COMP_Internal_Scale
  * @{
  */
...
static uint32_t CompRezSy = 0;
  ...
  /* Configure PORTE pins 8 (COMP_IN3) */
...
/** @} */ /* End of group COMP_Internal_Scale_91 */
