  /**
  @page UART_Interrupt_93 UART_Interrupt for MDR32F9Q3 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2011 Milandr ***********************************
  * @file    Examples/MDR32F9Q3_EVAL/UART/UART_Interrupt/readme.txt
...
@par Hardware and Software environment:
  ...
  - Pin 18 of X24.1 and Pin 5 X24.2 must be connected together.
