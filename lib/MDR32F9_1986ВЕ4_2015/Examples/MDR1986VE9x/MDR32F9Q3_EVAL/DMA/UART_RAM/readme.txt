  /**
  @page UART_RAM_93 UART_RAM for MDR32F9Q3 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2011 Milandr ***********************************
  * @file    Examples/MDR32F9Q3_EVAL/DMA/UART_RAM/readme.txt
...
@par Hardware and Software environment:
  ...
  - Connect UART1 RXD pin (X24.1.19) to UART2 TXD pin (X25.1.20).
  - Connect UART1 TXD pin (X24.1.18) to UART2 RXD pin (X25.1.19).
