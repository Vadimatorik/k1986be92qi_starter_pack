  /**
  @page Sector_Operations_92 Sector_Operations for MDR32F9Q2 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2011 Milandr *******************************
  * @file    Examples/MDR32F9Q2_EVAL/EEPROM/Sector_Operations/readme.txt
...
@par Hardware and Software environment:
  ...
  - This example is intended to run on MDR32F9Q2 eval board with MDR32F9Q2Y microcontroller.
