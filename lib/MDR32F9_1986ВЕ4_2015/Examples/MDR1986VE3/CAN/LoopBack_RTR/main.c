/**
  ******************************************************************************
  * @file    Examples/MDR1986VE3_EVAL/CAN/LoopBack_RTR/main.c
...
/** @addtogroup CAN_LoopBack_RTR_3T CAN_LoopBack_RTR
  * @{
  */
...
uint32_t main(void)
{
  ...
  /* Configure PORTB pins 10,11 for output to switch LED on/off */
