...
/** @addtogroup DAC_DMA_SineWave_3T DAC_DMA_SineWave
  * @{
  */
...
uint16_t Sine12bit[32] IAR_SECTION ("EXECUTABLE_MEMORY_SECTION") __attribute__((section("EXECUTABLE_MEMORY_SECTION"))) = {2047, 2447, 2831, 3185, 3498, 3750, 3939, 4056, 4095, 4056,
...
#endif
{
  ...
  while(RST_CLK_GetFlagStatus(RST_CLK_FLAG_HSERDY) != 1);
  ...
  RST_CLK_PCLK2cmd(RST_CLK_PCLK2_SSP4, ENABLE);
  SSP_DMACmd(MDR_SSP4, SSP_DMA_TXE, DISABLE);
  ...
  RST_CLK_PCLKcmd((RST_CLK_PCLK_SSP1 | RST_CLK_PCLK_SSP2 | RST_CLK_PCLK_SSP3),ENABLE);
  RST_CLK_PCLK2cmd((RST_CLK_PCLK2_SSP4),ENABLE);
...
/** @} */ /* End of group DAC_DMA_SineWave_3T */
