  /**
  @page ARINC_3T ARINC for MDR1986VE3 Coplexity Evaluation Board
  @latexonly
  @verbatim
...
@par Directory "Examples/MDR1986VE3/ARINC" contains:
  - ARINC/src/main.c                Main program
  - ARINC/src/MDR1986VE3_IT.c      Main Interrupt Service Routines
  - ARINC/inc/MDR1986VE3_IT.h      Functions prototypes for the interrupt

@par Hardware and Software environment:

  - This example is intended to run on MDR1986VE3 eval board with 
  	MDR1986VE3 microcontroller.
  - Pin PB0 must be connected to pin PH10.
  - Pin PB1 must be connected to pin PH11.
  - VD7 jamper must be enable.
  - VD8 jamper must be enable.
