/**
 ******************************************************************************
 * @file    Examples/MDR1986VE3_EVAL/RST_CLK/CPU_Clock/main.c
...
/** @addtogroup RST_CLK_CPU_Clock_3T RST_CLK_CPU_Clock
 * @{
 */
...
void main ( void )
{
	...
	PORT_InitStructure.PORT_Pin = (PORT_Pin_All	& ~(PORT_Pin_0 | PORT_Pin_1
			                    | PORT_Pin_2 | PORT_Pin_3 | PORT_Pin_4));
	PORT_Init(MDR_PORTB, &PORT_InitStructure);

	/* Configure PORTB pins 7..11 for output to switch LEDs on/off */
...
/** @} *//* End of group RST_CLK_CPU_Clock_3T */
