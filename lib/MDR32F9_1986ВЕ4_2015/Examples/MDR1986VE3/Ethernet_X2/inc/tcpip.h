...
#define MAC_5				0x00//0x20//0xC8
#define MAC_4				0xC0//0x6A//0x60
#define MAC_3				0x9F//0x8A//0x00
#define MAC_2				0x34//0x16//0x67
#define MAC_1				0x89//0xD2//0xB1
#define MAC_0				0x15//0x63//0x6D
...
#define RemoteIP_1               192                 // our internet protocol (IP) address
#define RemoteIP_2               168
#define RemoteIP_3               38
#define RemoteIP_4               3
