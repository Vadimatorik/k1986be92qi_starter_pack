  /**
  @page Independent_3T Independent for MDR1986VE3 Complexity Evaluation Board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2013 Milandr ***********************************
  * @file    Examples/MDR1986VE3/IWDG/Independent/readme.txt
...
@par Hardware and Software environment:
  ...
  - VD5 (LED0) are connected to PB.0 pin.
