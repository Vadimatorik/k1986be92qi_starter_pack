  /**
  @page SPI_FullDuplex SPI_FullDuplex for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2014 Milandr ***********************************
  * @file    Examples/MDR1986BE4_EVAL/SSP/SPI_FullDuplex/readme.txt
...
This example provides a description of how to init SPI1 in master mode.
