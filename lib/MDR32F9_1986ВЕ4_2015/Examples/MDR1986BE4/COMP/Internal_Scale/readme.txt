  /**
  @page Internal_Scale Internal_Scale for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2014 Milandr ***********************************
  * @file    Examples/MDR1986BE4_EVAL/COMP/Internal_Scale/readme.txt
  * @author Milandr Application Team
  * @version V1.0.0
  * @date    4/07/2014
  * @brief   Description of the COMP Example.
  ******************************************************************************
...
That action includes the following steps:
  - Configure PORTC lines 2,5  as COMP_IN1 and COPM_IN2;
  - Configure PORTA line 1  as COMP_OUT;
...
@par Directory "Examples/MDR1986BE4_EVAL" contains:
  ...
  - COMP/Internal_Scale/main.c             Main program
