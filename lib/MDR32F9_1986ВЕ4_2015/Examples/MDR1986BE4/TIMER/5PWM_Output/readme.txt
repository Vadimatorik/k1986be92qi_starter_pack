  /**
  @page TIMER_5PWM_Output TIMER_5PWM_Output for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
  ******************** (C) COPYRIGHT 2014 Milandr ***********************************
  * @file    Examples/MDR1986BE4_EVAL/TIMER/5PWM_Output/readme.txt
...
@par Example Description
  ...
  This example shows how to configure the TIM1 peripheral to generate 1 PWM signals.
