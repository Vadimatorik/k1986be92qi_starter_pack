/**
  ******************************************************************************
  * @file    Examples/MDR1986BE4_EVAL/DAC/DMA_SineWave/main.c
...
/** @addtogroup DAC_DMA_SineWave DAC_DMA_SineWave
  * @{
  */
...
#endif
{
  ...
  RST_CLK_PCLKcmd((RST_CLK_PCLK_RST_CLK | RST_CLK_PCLK_DMA | RST_CLK_PCLK_PORTA),ENABLE);
