/**
  ******************************************************************************
  * @file    Demo_Init_MDR1986VE1T.c
  * @author  Milandr Application Team
  * @version V3.0.0
  * @date    09.09.2013
  * @brief   Initializes the demonstration application for MDR1986VE1T_Rev0 and
  *          MDR1986VE1T_Rev1 evaluation boards
  ******************************************************************************
  * <br><br>
...
/** @defgroup __MDR1986VE1T_Demo_Setup MDR1986VE1T evaluation boards specific
  * @{
  */

/** @defgroup __MDR1986VE1T_Demo_Setup_Private_Constants MDR1986VE1T Demo Setup Private Constants
  * @{
  */
...
/** @} */ /* End of group __MDR1986VE1T_Demo_Setup_Private_Constants */

/** @defgroup __MDR1986VE1T_Demo_Setup_Private_Variables MDR1986VE1T Demo Setup Private Variables
  * @{
  */

/** @} */ /* End of group __MDR1986VE1T_Demo_Setup_Private_Variables */

/** @defgroup __MDR1986VE1T_Demo_Setup_Private_Functions MDR1986VE1T Demo Setup Private Functions
  * @{
  */
...
/************************ Joystick Initialization *************************/
  ...
  /* Configure PORTE pins 5, 8, 9, 10, 11, 15 for input to handle joystick events */
  PortInitStructure.PORT_Pin   = (PORT_Pin_5 | PORT_Pin_8 | PORT_Pin_9 |
                                  PORT_Pin_10 | PORT_Pin_11 | PORT_Pin_15);
  PortInitStructure.PORT_OE    = PORT_OE_IN;
  PortInitStructure.PORT_FUNC  = PORT_FUNC_PORT;
...
/************************ UART Initialization *************************/
    /* Configure PORTC pins 3..4 for output to switch UART_RX UART_TX */
  PortInitStructure.PORT_Pin   = PORT_Pin_3 | PORT_Pin_4;
  PortInitStructure.PORT_FUNC  = PORT_FUNC_MAIN;
...
/** @} */ /* End of group __MDR1986VE1T_Demo_Setup_Private_Functions */

/** @} */ /* End of group __MDR1986VE1T_Demo_Setup */
...
*
* END OF FILE Demo_Init_MDR1986VE1T.c */
